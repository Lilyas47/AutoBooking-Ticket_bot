...
def search_coord():
    ...
    image_path = 'D:\\Python_Problems\\AutoBookTicket_Script\\screenshot.png'  # поменять на свой путь
    image = cv2.imread(image_path)

    # Опредение диапазона цвета, который вы хотите найти
    lower_rgb = np.array([240, 231, 0])  # Например, [60, 100, 50]
    upper_rgb = np.array([250, 241, 0])  # Например, [100, 140, 90]
    ...
    contoured_image_path = 'D:\\Python_Problems\\AutoBookTicket_Script\\contoured_screenshot.png'  # поменять на свой
    # путь
